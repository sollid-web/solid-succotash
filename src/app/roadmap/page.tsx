...
const PHASES = [
  ...
  },
  {
    ...
    status: "active",
    items: [
      "✓ Public presale completed — BSCScan & Sourcify verified",
      "✓ BSCScan token profile approved",
      "✓ PancakeSwap V2 liquidity pool live — WOLV/BNB",
      "✓ DEX trading enabled for WOLV — September 2026",
      "✓ 231+ token holders on-chain",
      "CoinGecko listing application — in progress",
      "CoinMarketCap listing application — in progress",
      "Liquidity pool growth & market making strategy",
    ],
  },
  {
    phase: "Phase 5",
