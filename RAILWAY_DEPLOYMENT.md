...
In Railway dashboard, go to your Django service → **Variables** tab and add:
...
- ✅ `CORS_ALLOWED_ORIGINS` limited to frontend domain only
- ✅ `CSRF_TRUSTED_ORIGINS` matches CORS + backend domain
