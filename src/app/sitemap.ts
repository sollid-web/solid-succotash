...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/bnb-smart-chain-staking-guide`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/learn`,         lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/fees-withdrawals-custody`, lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
    { url: `${baseUrl}/security-audit-status`, lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
