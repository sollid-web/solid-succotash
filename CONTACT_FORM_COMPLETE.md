...
4. Copy each variable:
   ...
   ADMIN_EMAIL_RECIPIENTS=admin@wolvcapital.com,support@mail.wolvcapital.com,...  ← UPDATE
...
4. Ensure `DEFAULT_FROM_EMAIL` uses a verified sender (e.g. `support@mail.wolvcapital.com`)
...
4. **Update sender email** - Ensure support@mail.wolvcapital.com is verified in Resend
