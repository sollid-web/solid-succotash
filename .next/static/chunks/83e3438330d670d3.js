...
`;e.s(["en_US_default",()=>t])},896137,e=>{"use strict";var t=e.i(789594),o=e.i(789408),r=e.i(348396),n=e.i(170778),a=e.i(210920);function s(e={}){let{abi:i,address:l,functionName:c,query:p={}}=e,u=e.code,d=(0,a.useConfig)(e),h=(0,n.useChainId)({config:d}),y=function(e,r={}){return{async queryFn({queryKey:o}){let n=r.abi;if(!n)throw Error("abi is required");let{functionName:a,scopeKey:s,...i}=o[1],l=(()=>{let e=o[1];if(e.address)return{address:e.address};if(e.code)return{code:e.code};throw Error("address or code is required")})();if(!a)throw Error("functionName is required");return(0,t.readContract)(e,{abi:n,functionName:a,args:i.args,...l,...i})},queryKey:function(e={}){let{abi:t,...r}=e;return["readContract",(0,o.filterQueryOptions)(r)]}(r)}}(d,{...e,chainId:e.chainId??h}),w=!!((l||u)&&i&&c&&(p.enabled??!0));return(0,r.useQuery)({...p,...y,enabled:w,structuralSharing:p.structuralSharing??o.structuralSharing})}e.s(["useReadContract",()=>s],896137)}]);