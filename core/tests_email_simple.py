"""
Test email utility - DEPRECATED: Use core/management/commands/send_test_email.py instead
...
class Command(BaseCommand):
    help = 'Send test emails for verification (DEPRECATED - use send_test_email command)'
