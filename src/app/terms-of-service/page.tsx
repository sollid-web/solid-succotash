          ...
          <div style={{ display: 'flex', gap: '14px' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              {[
                ...
                { title: 'Margin and Account Risk', text: 'Investments may be subject to margin requirements. If your account falls below required thresholds, positions may be reduced or closed automatically. You are obligated to deposit additional funds immediately in the event of a margin call or account shortfall.' },
