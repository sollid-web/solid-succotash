...
class UserInvestment(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Admin-safe lifecycle logic.
        Allows recovery edits without blocking.
        """
        if self.started_at and not self.ends_at:
            self.ends_at = self.started_at + timezone.timedelta(
    ...
    def total_return(self):
        ...
        projected = self.amount * (
            Decimal("1") + (roi_rate / Decimal("100")) * duration
        )
