              ...
              <div className="panel-readable rounded-xl p-6 sm:p-10">
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4 items-center">
                  ...
                  <div className="flex gap-2 justify-end">
                    <button onClick={() => window.print()} className="px-4 py-2 rounded-md text-white bg-[#0b2f6b] hover:bg-[#0a285c] text-sm font-semibold shadow">
                      Print / Save PDF
                    </button>
                    <Link href="/" className="px-4 py-2 rounded-md text-[#0b2f6b] bg-white border border-[#0b2f6b]/20 text-sm font-semibold shadow">
                      Back to Home
                    </Link>
                  </div>
                </div>
