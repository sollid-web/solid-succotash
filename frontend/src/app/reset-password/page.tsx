...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => router.push("/accounts/login"), 3000);
    } catch {
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
          <Link href="/">
            <Image src="/logo.png" alt="WolvCapital" width={160} height={40} priority />
          </Link>
        </div>
          ...
          {success ? (
            ...
            <>
              ...
              <p className="text-[#888888] text-sm mb-6">
                Choose a strong password for your WolvCapital account.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm text-[#888888] mb-1.5">New password</label>
                  <input
                    type="password"
                    value={password}
                ...
                <div>
                  <label className="block text-sm text-[#888888] mb-1.5">Confirm new password</label>
                  <input
                    type="password"
                    value={password2}
