    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100 py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/dashboard/purchase-card" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-indigo-600 text-[#0F172A] rounded-lg hover:bg-indigo-700">Purchase Card</Link>
        </div>
