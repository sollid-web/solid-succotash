...
class UserNotification(models.Model):
    ...
    action_url = models.CharField(max_length=255, blank=True, help_text="URL for user to take action")
    entity_type = models.CharField(max_length=20, blank=True, help_text="e.g., 'transaction', 'investment'")
    entity_id = models.CharField(max_length=100, blank=True, help_text="UUID or ID of related entity")
